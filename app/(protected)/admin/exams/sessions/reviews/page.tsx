      ...
      <div className="flex h-full w-full flex-col items-center gap-6">
        <div className="flex w-full flex-row flex-wrap items-end justify-between gap-y-4">
          <div className="flex flex-col items-start">
            ...
            <p className="text-sm">
              View and manage exam sessions pending review.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-3">
              {examSessions?.length > 0 &&
                examSessions.map((session) => (
                  <Card
                    key={session.id}
                    className="cursor-pointer border-l-4 border-l-yellow-500 p-3 transition-colors duration-200 ease-in-out hover:bg-gray-50"
                    onClick={() => {
                      router.push(
          ...
          {!isLoading &&
            ...
            examSessions.length === 0 && (
              <div className="bg-muted flex h-full w-full flex-1 flex-col items-center justify-center gap-4 rounded-lg">
                ...
                <p className="text-muted-foreground font-bold">
                  No exam sessions pending review found.
                </p>
              </div>
            )}
        </div>
